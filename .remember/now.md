...
## 07:13 | main
Added `proje-yonetimi` skill as 6th Clara role—discovered it was missing despite 12 of 49 recent commits being this work; moved it from buried in `oturum-duzeni` to standalone 125-line doc, removed duplicate (applying `CLA-FIX-THE-CAUSE`: fix root cause not symptom), updated role list 5→6, verified new Clara correctly identifies all 6 roles; commit 6328c7f pending.
## 07:20 | main
