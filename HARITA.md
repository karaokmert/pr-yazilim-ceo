...
- **Agent araç envanteri** — 46 built-in araç var, fabrika 7 kullanıyor; `Skill` aracı fabrikada var OY'de yok (preload çözümü olabilir); doküman `skills:` konusunda gerçekle çelişiyor · 2026-08-03 · `incelemeler/agent-arac-envanteri/kayit.md` · yarım (`Skill` aracı ölçülmedi)
