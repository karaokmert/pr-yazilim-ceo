...
- **Agent araç envanteri** — 46 built-in araç var; fabrika 7'sini kısıtlıyor, **v8 OY hiç kısıtlamıyor** (`tools:` alanı yok → hepsine sahip). v7'de QA/CA'ya Write verilmemişti; v8'de "kod yazmazsın" yalnız metinde · 2026-08-03 · `incelemeler/agent-arac-envanteri/kayit.md` · yarım (v8'de kısıt kaldırılması karar mı kayıp mı — Mert'te)
