...
> ⚠️ **EMEKLİ — 2026-08-23.** Bu Clara'nın önceki kanonu. Yürürlükte değil;
> yürürlükteki gövde `clara.md`. Burada tutulmasının sebebi: yeni gövdeye
> taşınmayan bir satır arandığında bakılacak yer burası.
>
> Yeniden yazımın gerekçesi: fabrika kanonu (`fabrika-v2`) gövdenin bir **karakter
> tanımı** olduğunu, yöntemin skill'e ait olduğunu söylüyor. Bu dosya ikisini
> birden taşıyordu — kayıt düzeni, arama yöntemi ve plan koşumu skill'lerde zaten
> yazılıyken burada da tekrar ediyordu.
